...
* [Workshop: Building an AI-Powered Google Calendar Time Tracker](workshop-calendar-time-tracker.md) - Step-by-step hands-on workshop guide for building a Google Calendar time writing add-on powered by Gemini AI, progressing from a zero-setup Apps Script prototype to a production Go Alternate Runtime on Cloud Run.
