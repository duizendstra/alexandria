...
// transport-level retry (github.com/duizendstra/alexandria/go/platform/retry) with exponential backoff,
...
// (github.com/duizendstra/alexandria/go/platform/retry/gcp) so it also protects services that were not
