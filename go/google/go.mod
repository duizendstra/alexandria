module github.com/duizendstra/alexandria/go/google

go 1.26

require (
	cloud.google.com/go/auth v0.23.2
	github.com/duizendstra/alexandria/go/retry v1.1.0
	github.com/duizendstra/alexandria/go/retry/gcp v1.1.1
