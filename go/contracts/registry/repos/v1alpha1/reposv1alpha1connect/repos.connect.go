...
package reposv1alpha1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1alpha1 "github.com/duizendstra/alexandria/go/contracts/registry/repos/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	RepoServiceName = "registry.repos.v1alpha1.RepoService"
)
...
const (
	...
	RepoServiceListRepositoriesProcedure = "/registry.repos.v1alpha1.RepoService/ListRepositories"
)

// RepoServiceClient is a client for the registry.repos.v1alpha1.RepoService service.
...
// NewRepoServiceClient constructs a client for the registry.repos.v1alpha1.RepoService service. By
...
func NewRepoServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RepoServiceClient {
	...
	repoServiceMethods := v1alpha1.File_registry_repos_v1alpha1_repos_proto.Services().ByName("RepoService").Methods()
...
// ListRepositories calls registry.repos.v1alpha1.RepoService.ListRepositories.
func (c *repoServiceClient) ListRepositories(ctx context.Context, req *connect.Request[v1alpha1.ListRepositoriesRequest]) (*connect.Response[v1alpha1.ListRepositoriesResponse], error) {
	return c.listRepositories.CallUnary(ctx, req)
}

// RepoServiceHandler is an implementation of the registry.repos.v1alpha1.RepoService service.
...
func NewRepoServiceHandler(svc RepoServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/registry.repos.v1alpha1.RepoService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedRepoServiceHandler) ListRepositories(context.Context, *connect.Request[v1alpha1.ListRepositoriesRequest]) (*connect.Response[v1alpha1.ListRepositoriesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("registry.repos.v1alpha1.RepoService.ListRepositories is not implemented"))
}
