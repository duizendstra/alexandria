...
> The tag `go/observability/audit/v2.0.0` was cut for this same content by a
> release-please rescan that re-counted the v0.0.3 breaking change. It was never
> resolvable by Go (the module path carries no `/v2` suffix) and is withdrawn;
> nothing between v1.0.0 and v1.1.0 breaks the API. Consumers pin v1.1.0.
