...
|---|---|---|---|
| [retry](go/retry/) | `github.com/duizendstra/alexandria/go/retry` | v1.0.0 | Exponential backoff/jitter retries and transient HTTP roundtrip retries |
...
| [google](go/google/) | `github.com/duizendstra/alexandria/go/google` | v0.2.0 | Google Workspace authenticator builders, client factories, CRM & Service Usage clients |
| [dataquality/datadiff](go/dataquality/datadiff/) | `github.com/duizendstra/alexandria/go/dataquality/datadiff` | v0.2.0 | Proves two datasets equivalent through layered comparison |
...
| [platform/buildstamp](go/platform/buildstamp/) | `github.com/duizendstra/alexandria/go/platform/buildstamp` | v0.2.0 | Build provenance stamping and strict pre-run verification (commit, dirty tree, dependency revisions) |
...
| [platform/procrun](go/platform/procrun/) | `github.com/duizendstra/alexandria/go/platform/procrun` | v0.2.0 | Run external commands under a controlled environment (scrubbed env, fixed PATH, output to file) |
| [platform/runstate](go/platform/runstate/) | `github.com/duizendstra/alexandria/go/platform/runstate` | v0.2.0 | Per-subject run lock and short-lived, fingerprint-bound leases on disk |
...
| [platform/workflow](go/platform/workflow/) | `github.com/duizendstra/alexandria/go/platform/workflow` | v0.1.0 | Context-aware sequential step procedure engine with panic recovery, skip predicates, and lifecycle hooks |
| [governance](go/governance/) | `github.com/duizendstra/alexandria/go/governance` | v0.4.0 | Pure-Go governance domain model (scope, tiers, hierarchy, classification) |
...
| [iac/pulumi/runner](go/iac/pulumi/runner/) | `github.com/duizendstra/alexandria/go/iac/pulumi/runner` | v0.1.0 | Programmatic Pulumi CLI automation engine built on procrun |
...
| [iac/observability](go/iac/observability/) | `github.com/duizendstra/alexandria/go/iac/observability` | v0.3.0 | Configuration-driven Pulumi blueprint provisioning an observability project (log dataset, org audit-log sink, optional uptime checks + alert channel) |
