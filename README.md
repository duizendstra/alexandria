...
| [google](go/google/) | `github.com/duizendstra/alexandria/go/google` | v0.3.0 | Google Workspace authenticator builders, client factories, CRM & Service Usage clients |
...
| [platform/runstate](go/platform/runstate/) | `github.com/duizendstra/alexandria/go/platform/runstate` | v0.3.0 | Per-subject run lock and short-lived, fingerprint-bound leases on disk |
...
| [governance](go/governance/) | `github.com/duizendstra/alexandria/go/governance` | v1.0.0 | Pure-Go governance domain model (scope, tiers, hierarchy, classification) |
...
| [iac/pulumi/runner](go/iac/pulumi/runner/) | `github.com/duizendstra/alexandria/go/iac/pulumi/runner` | v0.2.0 | Programmatic Pulumi CLI automation engine built on procrun |
