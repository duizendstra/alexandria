...
| [platform/retry](go/platform/retry/) | `github.com/duizendstra/alexandria/go/platform/retry` | v1.0.0 | Exponential backoff/jitter retries and transient HTTP roundtrip retries |
